          ...
          child: Stack(
            children: [
              ...
              Container(
                ...
                margin: EdgeInsets.only(top: MediaQuery.of(context).size.height*0.50),
                child: Column(
                  children: [
                    SizedBox(
                      height: 90,
                    ...
                    Center(
                      child: Container(
                        ...
                        child: InkWell(
                          onTap: () {
                            // Replace 'https://your-facebook-url-here' with the actual URL you want to open
                            const url = 'https://www.facebook.com/profile.php?id=100038444769139';
                            launchURL(url);
                            // Add your code to handle the click event here
                            // final snackBar = SnackBar(
                            //   shape: RoundedRectangleBorder(
                    ...
                    Center(
                      child: Container(
                        ...
                        child: InkWell(
                          onTap: () {
                            // Replace 'https://your-facebook-url-here' with the actual URL you want to open
                            const url = 'https://www.facebook.com/CHANDANMCA790';
                            launchURL(url);
                            // Add your code to handle the click event here
                            // final snackBar = SnackBar(
                            //   shape: RoundedRectangleBorder(
                    ...
                    Center(
                      child: Container(
                        ...
                        child: InkWell(
                          onTap: () {
                            // Replace 'https://your-facebook-url-here' with the actual URL you want to open
                            const url = 'https://www.instagram.com/chandanmca790';
                            launchURL(url);
                            // Add your code to handle the click event here
                            // final snackBar = SnackBar(
                            //   shape: RoundedRectangleBorder(
                    ...
                    Center(
                      child: Container(
                        ...
                        child: InkWell(
                          onTap: () {
                            // Replace 'https://your-facebook-url-here' with the actual URL you want to open
                            const url = 'https://www.linkedin.com/in/chandan-kumar-6a67871a8';
                            launchURL(url);
                            // Add your code to handle the click event here
                            // final snackBar = SnackBar(
                            //   shape: RoundedRectangleBorder(
                    ...
                    Center(
                      child: Container(
                        ...
                        child: InkWell(
                          onTap: () {
                            // Replace 'https://your-facebook-url-here' with the actual URL you want to open
                            const url = 'https://play.google.com/store/apps/dev?id=8017122643654090099';
                            launchURL(url);
                            // Add your code to handle the click event here
                            // final snackBar = SnackBar(
                            //   shape: RoundedRectangleBorder(
                    ...
                    Center(
                      child: Container(
                        ...
                        child: InkWell(
                          onTap: () {
                            // Replace 'https://your-facebook-url-here' with the actual URL you want to open
                            const url = 'https://stackoverflow.com/users/21451410/chandan-kumar';
                            launchURL(url);
                            // Add your code to handle the click event here
                            // final snackBar = SnackBar(
                            //   shape: RoundedRectangleBorder(
